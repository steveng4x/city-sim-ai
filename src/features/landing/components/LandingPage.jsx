...
export function LandingPage() {
  ...
  return (
    <PageTransition className="min-h-screen" variant="backward">
      <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500 selection:text-white flex flex-col overflow-x-hidden">
        ...
        <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-24 sm:py-32 relative overflow-hidden">
          ...
          >
            ...
            >
              A physics-based civilization simulator powered by Cellular
              Automata and Google Gemini. Watch tribes settle fertile lands,
              wage border wars, and evolve into megacities — all with cinematic
              60fps transitions.
            </motion.p>
