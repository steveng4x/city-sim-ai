    ...
    <aside className="w-80 glass-panel p-6 flex flex-col gap-6 overflow-y-auto z-10 border-r border-border-default">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between mt-4">
          <span
            className="text-xs text-text-secondary uppercase tracking-widest font-bold"
            aria-hidden="true"
          >
            Rivers
          </span>
          <button
            ...
            className={`w-8 h-4 rounded-full transition-colors relative focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-bg1 ${showRivers ? "bg-brand" : "bg-neutral-bg4"}`}
          >
            <div
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className={`w-8 h-4 rounded-full transition-colors relative focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-bg1 ${showResources ? "bg-brand" : "bg-neutral-bg4"}`}
          >
            <div
