    ...
    <aside className="w-80 glass-panel p-6 flex flex-col gap-6 overflow-y-auto z-10 border-r border-border-default">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label htmlFor="seaLevelInput" className="flex justify-between text-xs text-text-secondary">
            <span>Sea Level</span>{" "}
        ...
        <div className="space-y-3">
          <label htmlFor="factionsInput" className="flex justify-between text-xs text-text-secondary">
            <span>Factions</span>{" "}
