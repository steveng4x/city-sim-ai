      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-2">
          <motion.button
            ...
            className="flex-1 py-2 bg-neutral-bg3 hover:bg-neutral-bg4 border border-border-default rounded-lg text-xs font-bold text-text-primary transition-colors"
          >
            Rebuild
          </motion.button>
          <motion.button
